<template>
  <div class="leading-normal tracking-normal text-black bg-gradient-to-r from-slate-50 to-slate-300 ">
    ...
    <div id="home" data-aos="fade-up" class="pt-24">
      <div class="container lg:h-[80vh] px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">

        <div
          class="flex flex-col w-full justify-center items-center lg:items-start lg:w-2/5 lg:text-left lg:pl-10  text-center">
          <h1
            class="text-4xl sm:text-4xl xl:text-6xl text-white md:text-black md:text-5xl font-bold leading-tight mb-8 lg:text-6xl">
            Алуминиумски <br /> огради & тенди
          </h1>
          <p class="text-lg md:text-xl xl:text-2xl leading-normal mb-4 mx-4 md:mx-0 text-white md:text-black lg:mb-8">
      ...
      <div class="hidden md:block relative -mt-12 lg:-mt-24">
    ...
    <section id="about" class="bg-white border-b py-8 pt-10">
    ...
    <section id="gallery" class="bg-gray-100 py-8 pt-12">
